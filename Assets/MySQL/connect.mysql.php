...
$include = require_once('../../Model/id_token/model.clean.users.php');
$include = require_once('../../Model/id_token/model.id_token.php');
...
$Objet_token = new Model_Class_token();
$Objet_clean = new Model_Class_Clean();
